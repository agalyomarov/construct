...
$(function () {
    ...
    $('.valise__wrap__calculation .row-calc ul li, .box__logo__valise li').click(function (e) {
        ...
        //new mod
        //new mod
        if (par.hasClass('valise__calculation__color__1')) { // РѕРєРѕРЅС‚РѕРІРєР°
            var okon = $(this).attr('data-okon');
            $('.valise-images__layer_border img').attr('src', okon);
        }

        if (par.hasClass('valise__calculation__color__2')) { // РѕРєРѕРЅС‚РѕРІРєР°
            var nitka = $(this).attr('data-okon');
            $('.valise-images__layer_thread img').attr('src', nitka);
        }

        if (par.hasClass('valise__calculation__color__3')) { // РѕРєРѕРЅС‚РѕРІРєР°
            var nitka = $(this).attr('data-okon');
    ...
    $("a.valise__order").click(function(e) {
        ...
        form.find('h3').text('Р—Р°РєР°Р·Р°С‚СЊ "РђРІС‚РѕРјРѕР±РёР»СЊРЅС‹Р№ СЃР°РєРІРѕСЏР¶"');
