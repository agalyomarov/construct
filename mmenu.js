    ...
    function(e, t, n) {
        ...
        var S = (function() {
                ...
                return (
                    ...
                    (e.prototype._initNavbar = function(e) {
                        if (
                            (this.trigger("initNavbar:before", [e]), !_(e, ".mm-navbar").length)
                        ) {
                            var t = null,
                                n = null;
                            if (
                                (e.getAttribute("data-mm-parent") ?
                                    ...
                                    (t = e.mmParent) && (n = t.closest(".mm-panel")), !t || !t.matches(".mm-listitem_vertical"))
                            ) {
                                    ...
                                    if (n) {
                                        for (
                                            var i = {
                                                    ...
                                                    toExternal: n.matches('[rel="external"]') ||
        ...
        var G = "ontouchstart" in window || !!navigator.msMaxTouchPoints || !1,
            ...
            ce = function(e, t, n) {
                switch (
                    ((e.position = "left"),
                        (e.zposition = "back"), ["right", "top", "bottom"].forEach(function(n) {
                    ...
                    this.bind("initNavbar:after", function(e) {
                        if (!e.querySelector(".mm-navbar__breadcrumbs")) {
                            ...
                            for (
                                ...
                                if (!(s = s.closest(".mm-panel")).parentElement.matches(
                ...
                e.addEventListener("click", function(e) {
                        ...
                        if (n.matches("a"))
                            if (n.matches(".mm-navbar__tab_selected"))
                                ...
                                try {
                                    t.openPanel(
                                            t.node.menu.querySelector(n.getAttribute("href")), !1
                                        ),
                                        e.stopImmediatePropagation();
                                } catch (e) {}
                    }),
        ...
        var Se = function() {
            ...
            Te = function(e) {
                if (e) {
                    ...
                    if (
                        (e.closest(".mm-panel") || (e = _(this.node.pnls, ".mm-panel")[0]), !_(e, ".mm-panel__noresultsmsg").length)
                    ) {
                    ...
                    this._api.push("open", "close", "setPage"),
                        ...
                        this.bind("initMenu:before", function() {
                            n.clone &&
                                ...
                                document
                                .querySelector(n.menu.insertSelector)[n.menu.insertMethod](e.node.menu);
                        }),
                        this.bind("initMenu:after", function() {
                            j.call(e),
                    ...
                    (this.bind("initAddons:after", function() {
                            e.bind("initMenu:after", function() {
                                ...
                                e.bind("initNavbar:after", function() {
                                    this.trigger(
                                        "initNavbar:after:sr-aria", [].slice.call(arguments)
                                    );
                                }),
                                e.bind("openPanel:start", function() {
                                    this.trigger(
                                        "openPanel:start:sr-aria", [].slice.call(arguments)
                                    );
                                }),
                                ...
                                e.bind("initOpened:after", function() {
                                    this.trigger(
                                        "initOpened:after:sr-aria", [].slice.call(arguments)
                                    );
                                });
                        }),
                    ...
                    (this.bind("initAddons:after", function() {
                            e.bind("setPage:after", function() {
                                ...
                                e.bind("initBlocker:after", function() {
                                    this.trigger(
                                        "initBlocker:after:sr-text", [].slice.call(arguments)
                                    );
                                });
                        }),
            ...
            iconbar: function() {
                ...
                if (
                    ...
                    (["top", "bottom"].forEach(function(t, i) {
                            ...
                            "array" != o(s) && (s = [s]);
                            for (
                                var a = b("div.mm-iconbar__" + t), r = 0, c = s.length; r < c; r++
                            )
                                        ...
                                        (function(e) {
                                            ...
                                            return (
                                                g(e, ".nav-item").forEach(function(e) {
                                                    ...
                                                    if (
                                                        (e.matches(".active") &&
                                                            n.classList.add("Selected"), !e.matches(".nav-link"))
                                                    ) {
